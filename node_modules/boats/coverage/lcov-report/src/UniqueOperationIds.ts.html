...
<head>
    <title>Code coverage report for src/UniqueOperationIds.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> UniqueOperationIds.ts</h1>
        <div class='clearfix'>
...
class UniqueOperationIds {
  ...
  getUniqueOperationIdFromPath(
    ...
    filePath<span class="missing-if-branch" title="else path not taken" >E</span> = removeFileExtension(filePath.replace(stripValue, ''));
    ...
    for (let i = 0; i &lt; <span class="cstat-no" title="statement not covered" >filePathParts.length; ++i) {</span>
      if (filePathParts[<span class="cstat-no" title="statement not covered" >i] !== </span>sep) {
        switch (segmentStyle) {
        ...
        // u<span class="missing-if-branch" title="else path not taken" >E</span>pper case for camel and pascal for overall styling
