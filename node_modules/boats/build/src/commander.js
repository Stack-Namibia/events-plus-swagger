...
const commander_helperFunctions_1 = tslib_1.__importDefault(require("./commander.helperFunctions"));
// eslint-disable-next-line max-lines-per-function
exports.default = (args) => {
    const commander = commander_1.createCommand();
    commander
        ...
        .option('-$, --variables [value]', 'Array of variables to pass to the templates, eg "-$ host=http://somehost.com -$ apikey=321654987"', commander_collect_1.default, [])
        .option('-f, --functions [filepath]', 'Array of helper function relative paths, eg "-f ./helperOne.js -f ./helperTwo -f ./helperThree.ts"', commander_helperFunctions_1.default, [])
        ...
        .option('-I, --injectSnippet <snippet>', 'Eg "boats -I oa2/crud -R ./src/paths -N user" or "boats -I https://github/some/snippet.git -R ./src/paths -N user"')
        .option('-S, --subSnippetPath <snippet>', 'The subdir in the target to extract eg "boats -I https://github/some/snippet.git -S oa2/crud -R ./src/paths -N user"')
        .option('-R, --relativeTargetPath <snippet>', 'Eg boats -I oa2/crud -R ./src/paths -N user')
        .option('-N, --targetName <snippet>', 'Eg boats -I oa2/crud -R ./src/paths -N user')
        ...
        .option('--dontValidateOutput', 'When passed, the compiled file will not be validated')
