...
<head>
    <title>Code coverage report for src/interfaces/BoatsRc.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/interfaces</a> BoatsRc.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import $RefParser from '@apidevtools/json-schema-ref-parser';
<span class="cstat-no" title="statement not covered" >import { StringStyle } from '@/enums/StringStyle';</span>
