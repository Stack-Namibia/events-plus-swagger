...
<head>
    <title>Code coverage report for src/calculateIndentFromLineBreak.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> calculateIndentFromLineBreak.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">125x</span></td><td class="text"><pre class="prettyprint lang-js">export default (str: string, pointer: number): number =&gt; {
