...
<head>
    <title>Code coverage report for src/pathInjector.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> pathInjector.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import * as upath from 'upath';
...
&nbsp;
  enrichForSpecialCases(paths: Paths, sourceRoot?: string): Paths {
    if (<span class="missing-if-branch" title="else path not taken" >E</span>!sourceRoot) {
      return paths
    }
&nbsp;
